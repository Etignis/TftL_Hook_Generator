			...
			subs: [
				{
					...
					list: [
						...
						"В школьной столовой обновили оборудование и еда стала странноватой, но этого никто не замечает",
						"На отключенный домашний телефон приходят звонки, но сквозь помехи слова непонятны",
						"На отключенный таксофон в переулке приходят звонки, но сквозь помехи слова непонятны"
					]
				},
				{
					name: "Impossible",
					...
					list: [
						...
						"В результате удара молнии, робот получает самосознание и отправляется изучать мир"
					]
				},
				{
					name: "Dangerous",
					...
					list: [
						...
						"экспериментальный  танк с искусственным  интеллектом вырывается на свободу",
					]
				}
			]
			...
			subs: [
				{
					...
					list: [
						...
						"Кто-то подобрал на улице щенка. Его глаза слишком умные для животного.",
					]
				},
				{
					name: "Impossible",
				...
				},
				{
					...
					list: [
						...
						"Из экспериментальной фермы сбегают динозавры",
						"Новые роботы-шахтеры пытаются раздробить все, что видят",
					]
				}
			]
			...
			subs: [
				...
				},
				{
					...
					list: [
						...
						"Надвигается электромагнитная буря, которая сожжет всю электронику",
						"Ребенок утверждает, что он из 57 года"
					]
				},
				{
					name: "Weird",
					...
					list: [
						...
						"кто-то поменялся телами",
						"если ночью войти в тот заброшенный дом, и ровно в 00:17 вылезти через кухонное окно, вернёшься на сутки назад"
					]
				}
			]
			...
			subs: [
				{
					...
					list: [
						...
						"В Интситуте заселки приближение НЛО",
						"В вашем доме находится источник неизвестного сигнала"
					]
				},
				{
					name: "jail",
					...
					list: [
						...
						"лаборант приторговывает всякими штуками",
					]
				},
				{
					name: "Rotten",
			...
			subs: [
				{
					...
					list: [
						"очевидцы НЛО",
						"сообщения со звёзд",
						"На поляне в лесу 'фигуры на полях'",
						"В грозу старый рыбак выдит непонятный летающий объект"
					]
				},
				{
					name: "Second",
					...
					list: [
						...
						"Это не метеорит! Это корабль п̗͈̪̤͋̐̈́͠р̼̏и̧̃ше̩̱̍̾л͑͢ь͙̲̙̻̻̎̎̓̊͘ц̙̮̜̰̲̆̄̍͂͝е͖̳̦͆́̑в!",
						"Еще дымящийся кратер, из которого ведут следы"
					]
				},
				{
					name: "Third",
					...
					list: [
						...
						"Исследовательская группа инопланетян собирает образцы растений",
					]
				}
			]
			...
			subs: [
				{
					...
					list: [
						...
						"В семь вечера по телевизору идет странная программа, на экране белый шум и все взрослые не отрываясь час сидят перед телевизором",
						"Странные звуки раздаются из соседского подвала",
						"К соседям приехали племянники-близнецы",
						"Почти каждую ночь сосед тайком уходит из дома"
					]
				},
				{
					name: "Event",
					...
					list: [
						...
						"Включается аварийная серена Института"
					]
				},
				{
					name: "Family",
					...
					list: [
						...
						"Домашний питомец начинает светиться",
						"Домашний питомец пропадает и появляется в неожиданных местах",
						"Домашний питомец внимательно наблюдает за вашими действиями",
						"Старший брат приехал на каникулы",
						"У сестры новый парень",
						"У брата новая девушка",
						"У матери новый ухажёр",
						"У отца новая пассия",
						"Отец снова пьет",
						"если не исправишь отметки, о новом велосипеде и не мечтай!",
						"родители ссорятся",
						"брат сбежал из дома",
						"Домашний арест",
					]
				},
				{
					...
					list: [
						...
						"какое-то из выпавших событий уже случалось парк лет назад"
					]
				},
				{
					name: "Strangeers",
					...
					list: [
						...
						"С новыми соседями что-то не так",
						"В школе новый учитель, и он ко мне придирается",
						"В этот раз учитель пришел рассказать обо всем лично",
						"В классе новичок, и он угрожает моему авторитету",
						"Новый полицейский появляется всегда невовремя"
					]
				},
				{
					name: "Wildcard",
		...
		for (let i=1; i<7; i++) {
			if(oSet[i]>0) {
				switch (Number(oSet[i])) {
					...
					case 4: aResult.push(_getFromData(i, 4)); break;
